...
import NffvSample.PanelContainer;
import NffvSample.ScannerModules;
...
public class NffvApplication extends JFrame implements PanelContainer{
	...
	public NffvApplication(){
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\eclipse\\workspace\\StaffReg\\img\\logo.png"));
